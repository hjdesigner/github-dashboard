  ...
  const markup = `
		...
		<div class="hot__mobile-12 hot__tablet-12 hot__desktop-7">
			<ul>
				...
				<li data-language="pt"><i><svg class="icon-files-empty"><use xlink:href="#icon-files-empty" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>53 repositórios</li>
				<li data-language="en"><i><svg class="icon-files-empty"><use xlink:href="#icon-files-empty" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>53 repositories</li>
				<li data-language="pt"><i><svg class="icon-clock"><use xlink:href="#icon-clock" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>No Github há 6 anos</li>
				<li data-language="en"><i><svg class="icon-clock"><use xlink:href="#icon-clock" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>In Github there are 6 years</li>
