	...
	const markup = `
		...
		<div class="hot__mobile-12 hot__tablet-12 hot__desktop-7">
			<ul>
				...
				<li><i><svg class="icon-mail"><use xlink:href="#icon-mail" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>${data.email !== null ? data.email : ''}</li>
				<li><i><svg class="icon-account_balance"><use xlink:href="#icon-account_balance" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg></i>${data.company !== null ? data.company : ''}</li>
			</ul>
		</div>
	`;
